...
export async function createJob(data: JobFormData): Promise<Job> {
  ...
  const dbData = {
    ...
    dropoff_time: data.dropoff_time, // Add dropoff_time
  ...
  console.log('[jobsApi] dbData.dropoff_time:', dbData.dropoff_time);
  console.log('[jobsApi] Type of dbData.dropoff_time:', typeof dbData.dropoff_time);
  console.log('[jobsApi] Full dbData:', dbData);
  console.log('[jobsApi] === END BACKEND DATA LOG ===');
